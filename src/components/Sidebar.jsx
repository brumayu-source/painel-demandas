...
import { IconBoard, IconList, IconChart, IconGear, IconChevron, IconSignOut, IconClose } from './icons.jsx';

export default function Sidebar({ view, setView, activeTeamIds, setActiveTeamIds, onNewTask, open, onClose }) {
