...
const TITLES = { board: 'Quadro', list: 'Lista', overview: 'Painel geral', admin: 'Administração', solicitacoes: 'Solicitações', archived: 'Arquivadas' };
...
export default function Topbar({ view, search, setSearch, onMenuClick }) {
  ...
  return (
    <div id="topbar">
      ...
      <h1>{TITLES[view] || ''}</h1>
      {!canWrite && (view === 'board' || view === 'list') && <span className="readonly-pill">Somente visualização</span>}
