...
import {
  STAGES, CONTENT_FORMATS, fmtDateLong, fmtBytes, MAX_ATTACHMENT_BYTES,
  personColorVar, categoryColorVar,
} from '../lib/format.js';
        ...
        <div className="modal-body">
          ...
          <div className="field">
            ...
            <div className="seg-group">
              {CONTENT_FORMATS.map((f) => (
                <SegButton key={f.id} active={contentFormat === f.id} disabled={readOnly} onClick={() => setContentFormat(f.id)}>
                  {f.label}
                </SegButton>
              ))}
            </div>
          ...
          {contentFormat === 'video' ? (
            <div className="field">
              ...
              <input id="f-video" type="url" value={videoUrl} disabled={readOnly}
