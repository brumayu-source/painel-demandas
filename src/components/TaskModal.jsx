...
export default function TaskModal({ task, onClose }) {
  const { teams, assignableProfiles, createTask, updateTask, deleteTask, canWrite } = useData();
    ...
    <div className="modal-backdrop" onMouseDown={(e) => { if (e.target === e.currentTarget) onClose(); }}>
      <div className="modal">
        <div className="modal-head">
          <h2>{editing ? (readOnly ? 'Demanda' : 'Editar demanda') : 'Nova demanda'}</h2>
        ...
        <div className="modal-body">
          ...
          <div className="field-row">
            <div className="field">
              ...
              <select id="f-team" value={teamId} disabled={readOnly} onChange={(e) => setTeamId(e.target.value)}>
