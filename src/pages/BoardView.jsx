...
import { STAGES, stageColorVar, teamColorVar, daysDiff, todayStr, relDays, initials } from '../lib/format.js';
import { IconDots } from '../components/icons.jsx';
import TaskModal from '../components/TaskModal.jsx';

export default function BoardView({ activeTeamIds, activeAssigneeIds, activeClientIds, search, openNewSignal, onConsumeNewSignal }) {
  const { tasks, teams, clients, assignableProfiles, selectedClientId, updateTask, canWrite } = useData();
