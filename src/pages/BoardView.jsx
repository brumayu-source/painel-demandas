...
export default function BoardView({ activeTeamIds, search, openNewSignal, onConsumeNewSignal }) {
  const { tasks, teams, assignableProfiles, updateTask, canWrite } = useData();
