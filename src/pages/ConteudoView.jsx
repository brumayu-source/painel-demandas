...
import {
  contentFormatLabel, stageLabel, stageColorVar, personColorVar, initials,
...
export default function ConteudoView({ activeTeamIds, activeAssigneeIds, activeClientIds, activeCategoryIds, search }) {
  ...
  }, [attachmentsByTask, contentTasks]);
...
function CalItem({ task, thumb, onClick }) {
  return (
    <button type="button" className="cal-item" style={{ borderLeftColor: stageColorVar(task.stage) }} onClick={onClick} title={task.title}>
  ...
  return (
    <button className="content-card" onClick={onClick}>
      <div className="content-thumb">
        ...
        <span className="content-stage-badge" style={{ background: stageColorVar(task.stage) }}>{stageLabel(task.stage)}</span>
      </div>
