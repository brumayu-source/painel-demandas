...
import { fmtDateLong, categoryColorVar } from '../lib/format.js';
import RequestModal from '../components/RequestModal.jsx';
import TaskModal from '../components/TaskModal.jsx';

export default function SolicitacoesView() {
  const { isAdmin, isEditor } = useAuth();
  const { tasks, clients, categories, selectedClient, selectedClientId } = useData();
      ...
      <div className="request-list">
        {solicitacoes.map((t) => (
          ...
          >
            ...
            {categoryById(t.category_id) && (
              <span className="team-tag">
                <span className="team-dot" style={{ background: categoryColorVar(categoryById(t.category_id)) }} />
